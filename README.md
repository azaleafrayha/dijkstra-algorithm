...
* **Graph and Algorithm**: I learned by visualizing the logic (Nodes & Edges)<br><br>
&nbsp;&nbsp;&nbsp;&nbsp; <img src="dijkstra.jpeg" width="300" height="200"><br>
    ...
    * Dijkstra’s algorithm is basically just a very smart traveler moving across these edges to find the most efficient way to visit all the nodes. And inn my opinion, visualizing the logic made the code so much easier to write.
<br><br>
